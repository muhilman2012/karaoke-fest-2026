...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $participants = [
            ...
            ['name' => 'Staf Khusus Wakil Presiden', 'song' => '-'],
            ['name' => 'Biro Perencanaan dan Keuangan', 'song' => '-'],
            ['name' => 'Biro Tata Usaha dan Sumber Daya Manusia', 'song' => '-'],
            ['name' => 'Dharma Wanita Persatuan', 'song' => '-'],
            ['name' => 'Biro Pers, Media, dan Informasi', 'song' => '-'],
            ['name' => 'Biro Umum', 'song' => '-'],
            ['name' => 'Deputi Bidang Dukungan Kebijakan Perekonomian, Pariwisata, dan Transformasi Digital', 'song' => '-'],
            ['name' => 'Outsourcing', 'song' => '-'],
            ['name' => 'Mitra Kerja', 'song' => '-'],
            ['name' => 'Tim Sespri Wakil Presiden', 'song' => '-'],
            ['name' => 'Deputi Bidang Dukungan Kebijakan Pemerintahan dan Pemerataan Pembangunan', 'song' => '-'],
            ['name' => 'Deputi Bidang Dukungan Kebijakan Peningkatan Kesejahteraan Dan Pembangunan SDM', 'song' => '-'],
